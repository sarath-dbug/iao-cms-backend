  ...
  rows: [
    {
      ...
      footer_label: "Accessibility Statement",
    },
    {
      ...
      footer_label: "Toegankelijkheidsverklaring",
    },
    {
      ...
      footer_label: "Déclaration d'accessibilité",
    },
    {
      ...
      footer_label: "Barrierefreiheitserklärung",
    },
  ],
});
  ...
  rows: [
    {
      ...
      first_name: "Voornaam", last_name: "Naam", email: "E-mail",
      privacy_consent_before: "Ik ga akkoord met het ", privacy_consent_link: "Privacybeleid", privacy_consent_after: ".",
      submit: "Downloaden", form_submitting: "Bezig met verzenden…",
      form_error: "Er ging iets mis. Probeer later opnieuw of mail info@osteopathy.eu.",
      form_validation: "Vul alle verplichte velden in en ga akkoord met het privacybeleid.",
...
await seedSimplePage({
  ...
  rows: [
    { document_id: legalNoticeDocId, locale: "en", published_at: now, created_at: now, updated_at: now, title: "Legal Notice", footer_label: "Legal Notice", intro: "The fee that students pay for their training at the IAO is exempt from VAT.\nThe corresponding legal article for each country is listed below.", items: legalItems },
    { document_id: legalNoticeDocId, locale: "nl", published_at: now, created_at: now, updated_at: now, title: "Wettelijke vermelding", footer_label: "Wettelijke vermelding", intro: "De vergoeding die studenten betalen voor hun opleiding aan het IAO is vrijgesteld van BTW.\nHet overeenkomstige wetsartikel voor elk land wordt hieronder vermeld.", items: legalItems },
    { document_id: legalNoticeDocId, locale: "fr", published_at: now, created_at: now, updated_at: now, title: "Mentions légales", footer_label: "Mentions légales", intro: "La redevance que les étudiants paient pour leur formation à l'IAO est exonérée de TVA.\nL'article juridique correspondant pour chaque pays est indiqué ci-dessous.", items: legalItems },
    { document_id: legalNoticeDocId, locale: "de", published_at: now, created_at: now, updated_at: now, title: "Rechtlicher Hinweis", footer_label: "Rechtlicher Hinweis", intro: "Die Gebühr, die Studierende für ihre Ausbildung am IAO zahlen, ist von der Mehrwertsteuer befreit.\nDer entsprechende Rechtsartikel für jedes Land ist nachstehend aufgeführt.", items: legalItems },
  ],
});
  ...
  rows: [
    {
      ...
      title: "Terms and Conditions", footer_label: "Terms and Conditions",
    ...
    },
    {
      ...
      title: "Algemene Voorwaarden", footer_label: "Algemene voorwaarden",
    ...
    },
    {
      ...
      title: "Conditions Générales", footer_label: "Conditions générales",
    ...
    },
    {
      ...
      title: "Allgemeine Geschäftsbedingungen", footer_label: "Geschäftsbedingungen",
